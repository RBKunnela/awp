...
The namespace `https://awp.paybotfin.com/witness-record/v1` is a **format identifier**, not an endorsement of any particular emitter or receipt. Production `.com` host is intentional — many enterprises block or distrust `.dev` TLDs.
